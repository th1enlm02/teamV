...
public class Searching_user extends AppCompatActivity {
    EditText edit;
    Button uploadBTn;
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(Searching_user.this, "File Uploaded Successfully!!", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
    ...
    public void retrievePDFs(View view) {
        ...
        startActivity(new Intent(Searching_user.this, retrievePDF.class));
    }
